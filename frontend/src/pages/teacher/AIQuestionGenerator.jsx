...
export default function AIQuestionGenerator({ onQuestionsGenerated, onCancel }) {
  ...
  return (
  <div className="bg-gradient-to-br from-blue-50 via-blue-100 to-white rounded-2xl p-8 border border-gray-200 shadow-xl w-full max-w-4xl mx-auto mt-8">
    ...
    {success && (
      <div className="flex items-center gap-2 p-4 mb-4 bg-green-100 border border-green-300 rounded-lg">
    ...
    {activeTab === 'pdf' && (
      <div className="space-y-6">
        <div>
          <label className="block text-gray-800 font-medium mb-2">Upload Study Material</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label className="block text-gray-800 font-medium mb-2">Question Type</label>
            <select
          ...
          <div>
            <label className="block text-gray-800 font-medium mb-2">Number of Questions</label>
            <select
        ...
        <button
          ...
          className="w-full bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
    ...
    {activeTab === 'prompt' && (
      <div className="space-y-6">
        <div>
          <label className="block text-gray-800 font-medium mb-2">Enter Topic or Prompt</label>
          <textarea
            value={promptText}
            onChange={(e) => setPromptText(e.target.value)}
            placeholder="Enter the topic or detailed prompt for question generation. For example: 'Photosynthesis in plants'"
            className="w-full bg-white border border-gray-200 rounded-md px-3 py-3 text-gray-900 h-32 resize-none"
          />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Same select/input fields as PDF tab */}
          <div>
            <label className="block text-gray-800 font-medium mb-2">Question Type</label>
            <select
    ...
    <div className="flex gap-4 mt-8">
      <button
        onClick={onCancel}
        className="bg-transparent border border-gray-300 text-gray-600 hover:text-gray-900 hover:border-gray-600 px-6 py-3 rounded-lg font-semibold transition-colors"
      >
        Cancel
      </button>
    </div>
