    ...
    <header className="sticky top-0 z-30 bg-slate-900/80 backdrop-blur-xl shadow-2xl border-b border-blue-500/20">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <ul className="hidden md:flex gap-8 text-base font-medium">
          <li><Link to="/solutions" className="hover:text-blue-400 text-blue-200 transition-colors duration-200">Solutions</Link></li>
          <li><Link to="/success-stories" className="hover:text-blue-400 text-blue-200 transition-colors duration-200">Success Stories</Link></li>
          <li><Link to="/blog" className="hover:text-blue-400 text-blue-200 transition-colors duration-200">Blog</Link></li>
          <li><Link to="/about" className="hover:text-blue-400 text-blue-200 transition-colors duration-200">About Us</Link></li>
          <li><Link to="/contact" className="hover:text-blue-400 text-blue-200 transition-colors duration-200">Contact Us</Link></li>
        </ul>
    ...
    <section className="relative min-h-screen flex justify-center text-center pt-48 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-24 flex flex-col items-center">
        ...
        <div className="flex gap-6 mt-8 animate-fade-in-up">
          <Link to="/register" className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 group cursor-pointer">
          <div className="w-6 h-10 border-2 border-blue-400/50 rounded-full flex justify-center group-hover:border-blue-400 transition-colors duration-300">
            <div className="w-1 h-3 bg-blue-400/70 rounded-full mt-2 animate-pulse group-hover:bg-blue-400 transition-colors duration-300" style={{ animationDuration: '2s' }}></div>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <ParallaxElement speed={0.8} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-6 h-6 bg-blue-500/25 rounded-full animate-pulse" style={{ animationDuration: '4s' }}></div>
        <div className="absolute bottom-1/4 left-1/4 w-4 h-4 bg-blue-600/30 rounded-full animate-pulse" style={{ animationDuration: '6s' }}></div>
        <div className="absolute top-1/2 right-1/6 w-5 h-5 bg-blue-400/25 rounded-full animate-pulse" style={{ animationDuration: '5s' }}></div>
      </ParallaxElement>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-6 p-6 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-blue-400 mb-2">Advanced Analytics & Reporting</h3>
            ...
            <div className="flex items-start gap-6 p-6 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-blue-400 mb-2">Secure & Anti-Cheating Features</h3>
                <p className="text-blue-200 leading-relaxed">
            ...
            <div className="flex items-start gap-6 p-6 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-blue-400 mb-2">Real-time Assessment</h3>
                <p className="text-blue-200 leading-relaxed">
            ...
            <div className="flex items-start gap-6 p-6 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-blue-400 mb-2">Customizable Question Types</h3>
                <p className="text-blue-200 leading-relaxed">
  ...
  return (
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <ParallaxElement speed={0.7} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-16 h-16 bg-blue-500/15 rounded-full animate-pulse" style={{ animationDuration: '5s' }}></div>
        <div className="absolute bottom-40 right-40 w-12 h-12 bg-blue-600/20 rounded-full animate-pulse" style={{ animationDuration: '7s' }}></div>
        <div className="absolute top-1/2 left-1/3 w-8 h-8 bg-blue-400/18 rounded-full animate-pulse" style={{ animationDuration: '6s' }}></div>
        <div className="absolute bottom-1/3 right-1/4 w-10 h-10 bg-blue-500/15 rounded-full animate-pulse" style={{ animationDuration: '8s' }}></div>
      </ParallaxElement>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-3">AI-Powered Proctoring</h3>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-3">Instant Auto-Grading</h3>
                    <p className="text-blue-200 leading-relaxed text-lg">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-3">Performance Analytics</h3>
                    <p className="text-blue-200 leading-relaxed text-lg">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-3">Smart Notifications</h3>
                    <p className="text-blue-200 leading-relaxed text-lg">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-3">Browser Lockdown</h3>
                    <p className="text-blue-200 leading-relaxed text-lg">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/20">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-blue-400 mb-3">Comprehensive Reports</h3>
                    <p className="text-blue-200 leading-relaxed text-lg">
...
export default function Landing() {
  ...
  return (
    <div className="font-['Inter',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif] bg-gradient-to-br from-black via-black to-slate-900 min-h-screen flex flex-col relative overflow-hidden">
      ...
      <ParallaxElement speed={0.6} className="absolute top-20 left-20 w-8 h-8 bg-gradient-to-br from-black/60 to-blue-700/40 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.2} className="absolute top-40 right-32 w-6 h-6 bg-gradient-to-br from-black/50 to-blue-800/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.8} className="absolute bottom-40 left-32 w-7 h-7 bg-gradient-to-br from-black/40 to-blue-600/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.0} className="absolute bottom-20 right-20 w-5 h-5 bg-gradient-to-br from-black/45 to-blue-700/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.2} className="absolute top-1/3 left-1/4 w-4 h-4 bg-gradient-to-br from-black/40 to-blue-800/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.4} className="absolute top-1/2 right-1/4 w-6 h-6 bg-gradient-to-br from-black/45 to-blue-600/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.9} className="absolute bottom-1/3 right-1/3 w-5 h-5 bg-gradient-to-br from-black/40 to-blue-700/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.3} className="absolute top-1/4 right-1/6 w-3 h-3 bg-gradient-to-br from-black/45 to-blue-800/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.1} className="absolute bottom-1/4 left-1/6 w-3 h-3 bg-gradient-to-br from-black/40 to-blue-600/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.7} className="absolute top-2/3 left-1/3 w-4 h-4 bg-gradient-to-br from-black/45 to-blue-700/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.6} className="absolute top-20 left-20 w-8 h-8 bg-gradient-to-br from-black/95 to-slate-800/40 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.2} className="absolute top-40 right-32 w-6 h-6 bg-gradient-to-br from-black/90 to-slate-900/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.8} className="absolute bottom-40 left-32 w-7 h-7 bg-gradient-to-br from-black/85 to-slate-700/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.0} className="absolute bottom-20 right-20 w-5 h-5 bg-gradient-to-br from-black/95 to-slate-900/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.2} className="absolute top-1/3 left-1/4 w-4 h-4 bg-gradient-to-br from-black/85 to-slate-800/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.4} className="absolute top-1/2 right-1/4 w-6 h-6 bg-gradient-to-br from-black/90 to-slate-700/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.9} className="absolute bottom-1/3 right-1/3 w-5 h-5 bg-gradient-to-br from-black/85 to-slate-900/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.3} className="absolute top-1/4 right-1/6 w-3 h-3 bg-gradient-to-br from-black/90 to-slate-800/35 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.1} className="absolute bottom-1/4 left-1/6 w-3 h-3 bg-gradient-to-br from-black/85 to-slate-700/30 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.7} className="absolute top-2/3 left-1/3 w-4 h-4 bg-gradient-to-br from-black/95 to-slate-900/35 rounded-full animate-pulse z-50" />
      
      {/* Additional floating elements for more visual interest */}
      <ParallaxElement speed={0.5} className="absolute top-1/6 left-1/3 w-6 h-6 bg-gradient-to-br from-black/50 to-blue-700/40 rounded-lg animate-pulse z-50" />
      <ParallaxElement speed={1.5} className="absolute top-3/4 right-1/6 w-5 h-5 bg-gradient-to-br from-black/45 to-blue-800/35 rounded-lg animate-pulse z-50" />
      <ParallaxElement speed={0.8} className="absolute bottom-1/6 right-1/3 w-4 h-4 bg-gradient-to-br from-black/40 to-blue-600/30 rounded-lg animate-pulse z-50" />
      <ParallaxElement speed={1.0} className="absolute top-1/2 left-1/6 w-7 h-7 bg-gradient-to-br from-black/45 to-blue-700/35 rounded-lg animate-pulse z-50" />
      
      {/* More visible elements with higher opacity */}
      <ParallaxElement speed={0.4} className="absolute top-32 left-1/2 w-10 h-10 bg-gradient-to-br from-black/70 to-blue-800/50 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.6} className="absolute top-96 right-1/3 w-8 h-8 bg-gradient-to-br from-black/60 to-blue-700/45 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={0.3} className="absolute bottom-32 left-1/4 w-12 h-12 bg-gradient-to-br from-black/60 to-blue-800/40 rounded-full animate-pulse z-50" />
      <ParallaxElement speed={1.7} className="absolute bottom-96 right-1/4 w-9 h-9 bg-gradient-to-br from-black/60 to-blue-700/45 rounded-full animate-pulse z-50" />
